...
import "../../../src/taxInvoiceGenerator/media/css/styles.css";
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    setTaxes(
      taxes.map((tax) => {
        return {
          ...tax,
          taxAmount: Math.round((tax.taxPercentage * newSubTotal) / 100),
        };
      })
    );
  }, [items]);
  ...
  useEffect(() => {
    const newTotalWithTax = taxes.reduce(
      (accumulator, tax) => accumulator + tax.taxAmount,
      0
    );
              ...
              if (item.itemID == currItemID) {
                if (fieldName == "quantity" || fieldName == "unitPrice") {
                  const otherFieldName =
                    fieldName == "quantity" ? "unitPrice" : "quantity";
  ...
  const downloadPdf = () => {
    ...
    window.open(
      `http://localhost:3000/invoiceGenerator/downloadInvoice?data=${dataString}`
    );
  };
  ...
  return (
    <div id="taxInvoice">
      <div className="screenContainer">
        <div className="toolTitle">Advisory Invoice Generator</div>
        <div className="mainContainer">
          <div className="leftMainBox">
              ...
              <div className="headerInfoBox">
                <div className="companyName">
                  {currFocus == "advisoryCompanyName" ? (
                    <input
                      className="heading inputBox"
                      name="advisoryCompanyName"
                      value={data.advisoryCompanyName}
                    ...
                    <div
                      className="heading"
                      onClick={() => handleDivClick("advisoryCompanyName")}
                    >
                      {data.advisoryCompanyName}
                    </div>
                  )}
                </div>
                <div className="invoiceHeading">
                  {currFocus == "invoiceHeading" ? (
                    <input
                      className="heading alignRight inputBox"
                      name="invoiceHeading"
                    ...
                    <div
                      className="heading alignRight"
                      onClick={() => handleDivClick("invoiceHeading")}
                    >
                      {data.invoiceHeading}
                    </div>
                  )}
              ...
              <div className="headerInfoBox">
                <div>
                  {currFocus == "addressLine1" ? (
                    ...
                    <div onClick={() => handleDivClick("addressLine1")}>
                  ...
                  {currFocus == "addressLine2" ? (
                    ...
                    <div onClick={() => handleDivClick("addressLine2")}>
                  ...
                  {currFocus == "addressLine3" ? (
                    ...
                    <div onClick={() => handleDivClick("addressLine3")}>
                ...
                <div>
                  ...
                  {currFocus == "invoiceID" ? (
                    ...
                    <div
                      className="alignRight"
                      onClick={() => handleDivClick("invoiceID")}
                    >
                      {data.invoiceID}
                    </div>
                  )}
                  {currFocus == "poNumber" ? (
                    ...
                    <div
                      className="alignRight"
                      onClick={() => handleDivClick("poNumber")}
                    >
                      {data.poNumber}
                    </div>
                  )}
              ...
              <div className="headerInfoBox">
                <div>
                  {currFocus == "contactNo" ? (
                    ...
                    <div onClick={() => handleDivClick("contactNo")}>
                      {data.contactNo}
                    </div>
                  )}
                  {currFocus == "email" ? (
                    ...
                    <div onClick={() => handleDivClick("email")}>
                      {data.email}
                    </div>
                  )}
                </div>
                <div className="highlight">
                  {currFocus == "clientName" ? (
                    <input
                      className="inputBox alignRight highlight"
                      name="clientName"
                    ...
                    <div
                      className="alignRight"
                      onClick={() => handleDivClick("clientName")}
                    >
                      {data.clientName}
                    </div>
                  )}
                  {currFocus == "clientCompanyName" ? (
                    ...
                    <div
                      className="alignRight"
                      onClick={() => handleDivClick("clientCompanyName")}
                    >
            ...
            {currFocus == "userMessage" ? (
              <textarea
                className="userMessageTextArea textAreaBox"
                name="userMessage"
              ...
              <div
                className="userMessageDiv"
                onClick={() => handleDivClick("userMessage")}
              >
                {data.userMessage}
              </div>
            )}
            ...
            {currFocus == "conclusionMessage" ? (
              <textarea
                className="conclusionMessageTextArea textAreaBox"
              ...
              <div
                className="conclusionMessageDiv"
                onClick={() => handleDivClick("conclusionMessage")}
              >
